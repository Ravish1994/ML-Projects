...
def Correl_SR(path,i):
    ...
    DS        = Data.copy()
    Mask      = (DS['SR_SMAP']>0) & (DS['SR_SMAP']<20) & (DS['SR_SMAP']>0)
    ...
    Lat       = np.arange(20,32,0.36)
    Lon       = np.arange(71,87.8,0.36)
    ...
    plt.pcolor(lon,lat,SR2,cmap="YlGnBu")
    ...
    plt.title(f'Interpolated along SMAP gridpoints',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15)
    
    fig , ax2 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax2)
    plt.pcolor(lon,lat,SM1,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax2,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'SMAP Soil Moisture in cm3/cm3')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Day{i} 2020 Correlation: {CR} %',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15)
   
    DS['SR_SMAP'] = DS['SR_SMAP']/20
    import seaborn as sns
    plt.figure(figsize=(2,2))
    sns.lmplot(x='SR_SMAP',y='SM_SMAP',data=DS,line_kws={'color': 'black'})
...
def Weekly_Stacking_SM(Month_No,Week_No):
    ...
    fig , ax1 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax1)
    plt.pcolor(lon,lat,SR_u6,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'CYGNSS Surface Reflectivity in dB')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Month No. {Month_No} Week No. {Week_No}',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15)
    
    fig , ax1 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax1)
    plt.pcolor(lon,lat,SM_u6,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'SMAP Soil Moisture in cm3/cm3')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Month No. {Month_No} Week No. {Week_No} Correlation: {CR} %',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15) 
...
def WeeklyAvg_SM(Month_No,Week_No):
    ...
    fig , ax1 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax1)
    plt.pcolor(lon,lat,SR_avg,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'Avg Surface Reflectivity in dB')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Month No. {Month_No} Week No. {Week_No} Correlation: {CR} %',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15)
    ...
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'Avg SMAP Soil Moisture in cm3/cm3')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Month No. {Month_No} Week No. {Week_No} Correlation: {CR} %',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15) 
