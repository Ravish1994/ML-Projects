...
def SM_Daily_ESACCI_lat_lon(path):
    ...
    lat = ESACCI_Lat[235:275]
    lon = ESACCI_Lon[1012:1078]
    return lat,lon
...
def Daily_SM(Month_No,Week_No):
    ...
    for i in range(1,8):   
        ...
        plt.pcolor(lon,lat,SMa/100,cmap="YlGnBu")
        ...
        plt.title(f'Soil Moisture Month No.{Month_No} Week No{Week_No} Day-{i}',fontsize=25)
...
def Weekly_avg_SM(Month_No,Week_No):
    ...
    fig , ax1 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax1)
    plt.pcolor(lon,lat,SM_avg,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'Weekly Avg Soil Moisture')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Weekly average Soil Moisture Month No.{Month_No} Week No{Week_No}',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15) 
...
def Weekly_stacking_SM(Month_No,Week_No):
    ...
    fig , ax1 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax1)
    plt.pcolor(lon,lat,SM7/100,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'Weekly stacked Soil Moisture')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Weekly stacked Soil Moisture Month No.{Month_No} Week No{Week_No}',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15)