...
def Daily_SM(Month_No,Week_No):
    ...
    for i in range(1,8):
        ...
        plt.pcolor(Lon,Lat,SM,cmap="YlGnBu")
        DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
        plt.colorbar()
        plt.xlabel('Longitude',fontsize=25)
        plt.ylabel('Lattitude',fontsize=25)
        plt.title(f'SMAP Soil Moisture Month No.{Month_No} Week No{Week_No} Day-{i}',fontsize=25)
...
def Weekly_Avg_SM(Month_No,Week_No):
    ...
    fig , ax1 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax1)
    plt.pcolor(Lon7,Lat7,SM_avgf,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'Weekly Avg Soil Moisture')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Average Soil Moisture Month No.{Month_No} Week No{Week_No}',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15)  
...
def Weekly_Stack_SM(Month_No,Week_No):
    ...
    fig , ax1 = plt.subplots(figsize=(20, 10))
    DF3.plot(color = 'white', edgecolor = 'black',axes=ax1)
    plt.pcolor(Lon7,Lat7,SM_stkf,cmap="YlGnBu")
    DF3.plot(color = None, edgecolor = 'black',axes=ax1,alpha=0.1)
    cbar = plt.colorbar()
    cbar.set_label(f'Weekly stacked Soil Moisture')
    plt.xlabel('Longitude',fontsize=25)
    plt.ylabel('Lattitude',fontsize=25)
    plt.title(f'Weekly stacked Soil Moisture of Month No.{Month_No} Week No{Week_No}',fontsize=25)
    plt.tick_params(axis='both', which='major', labelsize=15) 